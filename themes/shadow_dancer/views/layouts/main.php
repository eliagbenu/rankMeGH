...
<div class="container" id="page">
	<div id="topnav" style="background-color:#f05a28;">

	</div>
	<div id="header" style="background-color:#ffffff;">
		<div id="logo"><?php echo CHtml::image(Yii::app()->request->baseUrl.'/images/logo.png'); ?></div>
	</div><!-- header -->
...
<?php /*$this->widget('application.extensions.mbmenu.MbMenu',array(
	...
	<div id="mainmenu">
		...
		<?php $this->widget('zii.widgets.CMenu',array(
			'items'=>array(
				...
				array('label'=>'Home', 'url'=>array('/site/homePage'), 'visible'=>!Yii::app()->user->isGuest),					
				//array('label'=>'Contact', 'url'=>array('/site/contact')),
				array('label'=>'District', 'url'=>array('/district/index'), 'visible'=>!Yii::app()->user->isGuest),								
				//array('label'=>'District', 'url'=>array('/district/customizedDistrictList'), 'visible'=>Yii::app()->user->isGuest),						
				array('label'=>'Login', 'url'=>array('/site/login'), 'visible'=>Yii::app()->user->isGuest),
				array('label'=>'Logout ('.Yii::app()->user->name.')', 'url'=>array('/site/logout'), 'visible'=>!Yii::app()->user->isGuest)
			),
		)); ?>
	...
	<div id="footer">
		Copyright &copy; <?php echo date('Y'); ?> by AFLEP.<br/>
